      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
         <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('add.category')}}">TAG</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="{{route('write.post')}}">Category</a>
          </li>
            
          <li class="nav-item">
            <a class="nav-link" href="{{route('admin.profile')}}">Admin Profile</a>
          </li>
